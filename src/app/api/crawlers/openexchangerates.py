...
class OpenExchangeRates(Crawler):
    ...
    def get_currencies(self) -> Any:
        return super().get_json(url=f'{self.base_url}/{self.currencies_endpoint}', params=f'app_id={self.api_key}')
    ...
    def get_rate(self, base: str = 'USD') -> Rate:
        ...
        rates_json = super().get_json(
            ...
            params=f'app_id={self.api_key}&symbols={",".join(currencies_json.keys())}'
        )
